...
- [ ] **MACR-01**: Замена Super+Буква → Ctrl+Буква на лету в определённых приложениях (механизм идентификации приложения — ADR фазы решения; допускается descoping в v2 при отсутствии надёжного механизма на уровне engine)
